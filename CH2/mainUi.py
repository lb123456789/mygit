...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.setNemeEdit1 = QtWidgets.QLineEdit(self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.setNemeEdit1.setFont(font)
        self.setNemeEdit1.setObjectName("setNemeEdit1")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.setNemeEdit1)
        ...
        self.PWDEdit2 = QtWidgets.QLineEdit(self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.PWDEdit2.setFont(font)
        self.PWDEdit2.setObjectName("PWDEdit2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.PWDEdit2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton1.setText(_translate("MainWindow", "登 录"))
